...
/* Backtested monthly OOZE, 2003 → latest, computed from public data by
   scripts/backtest.js. Calibration (published): calmest 2003-2025 month → 10,
...
/* Methodology v2 requires the NY Fed auto series, which begins in 2003. Trim
...
const EVENTS = [
  ...
  [2026,`MID-2026 — Methodology v2 live reading: ${TODAY_SCORE}/100.`],
];
...
/* Canonical Truth: prose never remembers numbers. Text carries tokens that
   resolve from HISTORY at render time: {{s:YYYY-MM}} = that month's score,
   {{peak:YYYY-MM..YYYY-MM}} = max score in the range. */
