...
<div class="ind-head"><div class="ind-title"><div class="intake">Ward M gauge · experimental</div><h1>${gauge.emoji} ${escapeHtml(gauge.name)}</h1></div><div class="contrib-chip">${gauge.sensor === 'credit' ? 'Shared series · this index also carries <b>3%</b> of the household jar (methodology v3)' : 'Separate instrument · <b>0 oz</b> in household jar'}</div></div>
...
<div class="prose"><p>${gauge.sensor === 'credit'
    ? '<strong>This gauge shares its series with the household jar.</strong> The Chicago Fed NFCI is one-sixth of the experimental Ward M raw composite and, since methodology v3, also carries 3% of the household Ooze Score as the Financial Conditions intake line. It is the only input the two instruments have in common; the wings are otherwise separate and are never averaged.'
    : '<strong>This gauge does not affect the household Ooze Score.</strong> It contributes one-sixth of the experimental Ward M raw composite before Ward M calibration.'}</p></div>
